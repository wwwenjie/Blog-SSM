...
--
-- Host: localhost
-- Generation Time: Apr 12, 2020 at 01:39 PM
...
CREATE TABLE `article` (
  `article_id` bigint(20) UNSIGNED NOT NULL COMMENT '博文ID',
  `user_id` bigint(20) UNSIGNED NOT NULL COMMENT '发表用户ID',
  `article_title` tinytext NOT NULL COMMENT '博文标题',
  `article_content` longtext COMMENT '博文内容',
  `article_views` bigint(20) UNSIGNED NOT NULL COMMENT '浏览量',
  `article_comment_count` bigint(20) UNSIGNED NOT NULL COMMENT '评论总数',
...
CREATE TABLE `comment` (
  ...
  `user_id` bigint(20) UNSIGNED DEFAULT NULL COMMENT '发表用户ID',
  `user_name` varchar(20) DEFAULT 'Anonymity' COMMENT '发表用户名',
  `user_ip` varchar(20) NOT NULL COMMENT '用户IP',
  `article_id` bigint(20) UNSIGNED NOT NULL COMMENT '评论博文ID',
...
CREATE TABLE `option` (
  `option_id` bigint(20) UNSIGNED NOT NULL COMMENT '选项ID',
...
--
ALTER TABLE `article`
  MODIFY `article_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '博文ID';

--
-- AUTO_INCREMENT for table `category`
--
ALTER TABLE `category`
  MODIFY `category_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '分类ID';

--
-- AUTO_INCREMENT for table `comment`
--
ALTER TABLE `comment`
  MODIFY `comment_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '评论ID';

--
-- AUTO_INCREMENT for table `label`
--
ALTER TABLE `label`
  MODIFY `label_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '标签ID';

--
-- AUTO_INCREMENT for table `option`
--
ALTER TABLE `option`
  MODIFY `option_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '选项ID', AUTO_INCREMENT=13;
